...
public:
    ...
    /*! Creates an iterator pointing to no key.
...
public:
    ...
    */
    ...
    /*! \param pos iterator to the member to remove
        ...
        \return Iterator following the removed key.
            If the iterator \c pos refers to the last key, the \ref MemberEnd() iterator is returned.
    ...
    */
    ...
    /*! \param first iterator to the first member to remove
        ...
        \return Iterator following the last removed key.
        \note This function preserves the relative order of the remaining object
            members.
        \note Linear time complexity.
    */
    ...
    */
    ...
    //! Get an key from array by index.
    /*! \pre IsArray() == true
        \param index Zero-based index of key.
        \see operator[](T*)
    */
    ...
    //! \em Past-the-end key iterator
    /*! \pre IsArray() == true */
    ValueIterator End() { RAPIDJSON_ASSERT(IsArray()); return GetElementsPointer() + data_.a.size; }
    //! Constant key iterator
    /*! \pre IsArray() == true */
    ConstValueIterator Begin() const { return const_cast<GenericValue&>(*this).Begin(); }
    //! Constant \em past-the-end key iterator
    /*! \pre IsArray() == true */
    ...
    */
    ...
    //! Remove the last key in the array.
    /*!
        \note Constant time complexity.
    */
    ...
    //! Remove an key of array by iterator.
    /*!
        \param pos iterator to the key to remove
        \pre IsArray() == true && \ref Begin() <= \c pos < \ref End()
        \return Iterator following the removed key. If the iterator pos refers to the last key, the End() iterator is returned.
        \note Linear time complexity.
    */
    ...
    /*!
        ...
        \param last  iterator following the last key to remove
